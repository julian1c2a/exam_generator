"""
Demostración: Pipeline Fase 1 + Fase 2

Muestra cómo fluye JSON a través del pipeline:
  JSON validado (Fase 1)
    ↓
  Phase1DataValidator.render() → JSON + TEX
    ↓
  Phase2StructureGenerator.render() → JSON + TEX
    ↓
  Pipeline output con ambas fases ejecutadas
"""
...
# EJEMPLO 1: Caso de uso simple - ConversionRow
# ============================================================================
